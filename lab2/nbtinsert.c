 ...
 *
 * TODO (1 of 2) — Declare extern references.
 *
 * You need access to the stats-enabled flag and the split counter
 * that you defined in nbtsearch_template.c.  Add extern declarations
 * for those two variables here.
 * --------------------------------------------------------------------------- */
/* YOUR CODE HERE */
			   ...
			   bool split_only_page)
{
	...
	if (PageGetFreeSpace(page) < itemsz)
	{
		...
		/*
		 * TODO (2 of 2) — Count the page split.
		 * A split just happened.  If stats collection is enabled,
